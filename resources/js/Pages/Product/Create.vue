...
const validateNumber = (field) => {
    ...
    form[field] = Number(value.replace(/[^0-9]/g, ''));
};
                                    ...
                                    <div>
                                        ...
                                        <div class="relative mt-1">
                                            ...
                                            <input
                                                type="text"
                                                id="production_cost"
                                                @input="validateNumber('production_cost')"
                                    ...
                                    <div>
                                        ...
                                        <div class="relative mt-1">
                                            ...
                                            <input
                                                type="text"
                                                id="sale_price"
                                                @input="validateNumber('sale_price')"
